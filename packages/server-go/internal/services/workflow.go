...
func (s *WorkflowService) CreateWorkflow(ctx context.Context, name, description, bpmnXML string) (*models.Workflow, error) {
...
func (s *WorkflowService) UpdateWorkflow(ctx context.Context, workflowID, name, description, bpmnXML string) (*models.Workflow, error) {
