...
func setupWorkflowExecutionHandlerTest(t *testing.T) (*WorkflowExecutionHandler, *gin.Engine) {
	logger := zerolog.Nop()
	...
	handler := NewWorkflowExecutionHandler(db, &logger, workflowSvc, instanceSvc, executionSvc)
...
func TestWorkflowExecutionHandler_ExecuteWorkflow_InvalidRequest(t *testing.T) {
	_, router := setupWorkflowExecutionHandlerTest(t)
...
func TestWorkflowExecutionHandler_ExecuteWorkflow_MissingInstanceId(t *testing.T) {
	_, router := setupWorkflowExecutionHandlerTest(t)
...
func TestWorkflowExecutionHandler_ExecuteWorkflow_ValidRequest(t *testing.T) {
	_, router := setupWorkflowExecutionHandlerTest(t)
